...
(async () => {
  await eventHubReader.startReadMessage((message, date, deviceId) => {
    try {
      ...
      payload.CreatedTime = parsed.readings[0].created;
      payload.Value = parsed.readings[0].value;
      console.log('Azure device: %s - [EdgeX service: %s, device: %s, value: %s, created: %s]', deviceId, payload.ServiceId, payload.DeviceId, payload.Value, payload.CreatedTime);
